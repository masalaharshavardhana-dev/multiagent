    ...
    def get_weather(self, city):
        if self.api_key:
            ...
            try:
                ...
                if not timelines:
                    return f"No timeline data for {city}"
                ...
                try:
                    ...
                    return f"The weather in {city} is {weathercode} with {temperature}°C"
            ...
            return "API key is missing. Please provide an API key."
